...
<meta name="description" content="Lydia Hotel template project">
...
<!--         <div class="search_button">
        ...
        <!-- Header Link -->
        <div class="header_link"><a href="#">Reserve Your Room Now</a></div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Reserve Your Stay</h1></div>
      <div class="home_text text-center">Some see things as they are and ask why. Others dream things that never were and ask why not. We too have a dream.</div>
